...
plt.xlabel('Expiry',fontsize=12)
plt.ylabel('Alpha',fontsize=12)
plt.title('Cubic_Spline_Tenor=10y_Alpha',fontsize=12)
plt.plot([1, 5, 10],[Cal_Alpha[4], Cal_Alpha[9], Cal_Alpha[14]],'b*')
plt.plot(np.linspace(1,10,50),Alpha10(np.linspace(1,10,50)),'r-')
plt.show()
...
plt.title('Cubic_Spline_Tenor=10y_Nu',fontsize=12)
plt.plot([1, 5, 10],[Cal_Nu[4], Cal_Nu[9], Cal_Nu[14]],'b*')
plt.plot(np.linspace(1,10,50),Nu10(np.linspace(1,10,50)),'r-')
plt.show()
...
plt.title('Cubic_Spline_Tenor=10y_Rho',fontsize=12)
plt.plot([1, 5, 10],[Cal_Rho[4], Cal_Rho[9], Cal_Rho[14]],'b*')
plt.plot(np.linspace(1,10,50),Rho10(np.linspace(1,10,50)),'r-')
plt.show()
...
plt.xlabel('Expiry',fontsize=12)
plt.ylabel('Alpha',fontsize=12)
plt.title('Cubic_Spline_Tenor=2y_Alpha',fontsize=12)
plt.plot([1, 5, 10],[Cal_Alpha[1], Cal_Alpha[6], Cal_Alpha[11]],'b*')
plt.plot(np.linspace(1,10,50),Alpha2(np.linspace(1,10,50)),'r-')
plt.show()
...
plt.xlabel('Expiry',fontsize=12)
plt.ylabel('Nu',fontsize=12)
plt.title('Cubic_Spline_Tenor=2y_Nu',fontsize=12)
plt.plot([1, 5, 10],[Cal_Nu[1], Cal_Nu[6], Cal_Nu[11]],'b*')
plt.plot(np.linspace(1,10,50),Nu2(np.linspace(1,10,50)),'r-')
plt.show()
...
plt.xlabel('Expiry',fontsize=12)
plt.ylabel('Rho',fontsize=12)
plt.title('Cubic_Spline_Tenor=2y_Rho',fontsize=12)
plt.plot([1, 5, 10],[Cal_Rho[1], Cal_Rho[6], Cal_Rho[11]],'b*')
plt.plot(np.linspace(1,10,50),Rho2(np.linspace(1,10,50)),'r-')
plt.show()
