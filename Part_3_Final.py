...
# Plot Interpolation of SABR Parameters
fig4, ax1 = plt.subplots(1,3, figsize=(12, 4), tight_layout=True )

ax1 = plt.subplot(1,3,1)
ax1 = plt.plot([1, 5, 10],[Cal_Alpha[4], Cal_Alpha[9], Cal_Alpha[14]],'b*', zorder = 1)  
ax1 = plt.plot(np.linspace(1,10,50),Alpha10(np.linspace(1,10,50)),'r-', zorder = 0)
ax1 = plt.ylabel('Alpha')
ax1 = plt.xlabel('Expiry')
ax1 = plt.grid(linestyle='--')
ax1 = plt.title('Cubic_Spline_Tenor=10y_Alpha')

ax2 = plt.subplot(1,3,2)
ax2 = plt.plot([1, 5, 10],[Cal_Nu[4], Cal_Nu[9], Cal_Nu[14]],'b*', zorder = 1)  
ax2 = plt.plot(np.linspace(1,10,50),Nu10(np.linspace(1,10,50)),'r-', zorder = 0)
ax2 = plt.ylabel('Nu')
ax2 = plt.xlabel('Expiry')
ax2 = plt.grid(linestyle='--')
ax2 = plt.title('Cubic_Spline_Tenor=10y_Nu')

ax3 = plt.subplot(1,3,3)
ax3 = plt.plot([1, 5, 10],[Cal_Rho[4], Cal_Rho[9], Cal_Rho[14]],'b*', zorder = 1)  
ax3 = plt.plot(np.linspace(1,10,50),Rho10(np.linspace(1,10,50)),'r-', zorder = 0)
ax3 = plt.ylabel('Rho')
ax3 = plt.xlabel('Expiry')
ax3 = plt.grid(linestyle='--')
ax3 = plt.title('Cubic_Spline_Tenor=10y_Rho')
ax3 = plt.savefig("Cubic_10y.png")
...
ax1 = plt.subplot(1,3,1)
ax1 = plt.plot([1, 5, 10],[Cal_Alpha[1], Cal_Alpha[6], Cal_Alpha[11]],'b*', zorder = 1)  
ax1 = plt.plot(np.linspace(1,10,50),Alpha2(np.linspace(1,10,50)),'r-', zorder = 0)
ax1 = plt.ylabel('Alpha')
ax1 = plt.xlabel('Expiry')
ax1 = plt.grid(linestyle='--')
ax1 = plt.title('Cubic_Spline_Tenor=2y_Alpha')

ax2 = plt.subplot(1,3,2)
ax2 = plt.plot([1, 5, 10],[Cal_Nu[1], Cal_Nu[6], Cal_Nu[11]],'b*', zorder = 1)  
ax2 = plt.plot(np.linspace(1,10,50),Nu2(np.linspace(1,10,50)),'r-', zorder = 0)
ax2 = plt.ylabel('Nu')
ax2 = plt.xlabel('Expiry')
ax2 = plt.grid(linestyle='--')
ax2 = plt.title('Cubic_Spline_Tenor=2y_Nu')

ax3 = plt.subplot(1,3,3)
ax3 = plt.plot([1, 5, 10],[Cal_Rho[1], Cal_Rho[6], Cal_Rho[11]],'b*', zorder = 1)  
ax3 = plt.plot(np.linspace(1,10,50),Rho2(np.linspace(1,10,50)),'r-', zorder = 0)
ax3 = plt.ylabel('Rho')
ax3 = plt.xlabel('Expiry')
ax3 = plt.grid(linestyle='--')
ax3 = plt.title('Cubic_Spline_Tenor=2y_Rho')
ax3 = plt.savefig("Cubic_2y.png")
